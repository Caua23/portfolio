...
export function Tec({ img, name, desc }) {
    return (
        <div className="hover:shadow-[0px_10px_24px_2px_#ffffff] duration-500 w-44 h-[400px] bg-neutral-800 flex flex-col justify-baseline items-center rounded-md p-4 hover:translate-y-[-10px]  transform transition-all">
