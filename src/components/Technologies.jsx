...
export function Technologies() {
    return (
        <div className="flex overflow-auto select-none h-full flex-wrap gap-8 justify-center items-center pt-32 pb-10 p-10"> 
            ...
            <Tec name="Nest.js" img="https://docs.nestjs.com/assets/logo-small-gradient.svg" desc="Nest.js is a progressive Node.js framework for building efficient, scalable, and enterprise-grade server-side applications using TypeScript." />
